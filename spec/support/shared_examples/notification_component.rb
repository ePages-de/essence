...
RSpec.shared_examples 'notification component' do |variant|
  ...
  it 'renders the component' do
    ...
    aggregate_failures do
      ...
      expect(page).to have_css(
        "body > div.notification.notification-#{variant} > div.notification-indicator > svg.notification-icon",
        count: 1
      )
      expect(page).to have_css(
        "body > div.notification.notification-#{variant} > div.notification-body",
        text: content,
        count: 1
      )
    end
  ...
  it 'renders with the given :html_options' do
    ...
    aggregate_failures do
      # TODO: Validate the correct icon
      expect(page).to have_css(
        "body > div.notification.notification-#{variant}.custom-class[data-john='doe']",
        count: 1
      )
      expect(page).to have_css(
        "body > div.notification.notification-#{variant} > div.notification-indicator > svg.notification-icon",
